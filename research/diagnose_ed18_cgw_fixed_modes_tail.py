#!/usr/bin/env python3
"""Tail-consistent wrapper for ``diagnose_ed18_cgw_fixed_modes.py``."""

from __future__ import annotations

import diagnose_ed18_cgw_fixed_modes as base
...
def main():
    ...
    print("NOTE: fixed-mode diagnostics use tail-consistent production H/F tangents")
    base.main()
