#!/usr/bin/env python3
"""Compare all-q JF response files across straight V' and crossed Vx."""
...
def main():
    ...
    rows.sort(key=lambda r: (r["Vprime"], r["Vcross"]))

    header = (
        "V'       Vx       global(lambda,q,mode)                         "
